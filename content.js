  ...
  (() => {
    ...
    new (class {
          ...
          window.addEventListener("message", e),
            ...
            chrome.runtime.onMessage.addListener((e, t, n) => {
              switch (e.type) {
                ...
                default:
                  return o("Unknown message " + e.type), !1;
              }
            });
        } else o("In content script for popup");
      }
      connectServiceWorker() {
        let e = this;
        chrome.runtime
          .connect({ name: "extensionUIRequest" })
          .onDisconnect.addListener(function () {
            o("Extension disconnected"), e.connectServiceWorker();
          });
      }
      injectWalletLinkProvider() {
        ...
        t.insertBefore(e, t.children[0]), t.removeChild(e);
      }
          ...
          window.postMessage(
            {
              ...
              data: { action: "loadedWalletLinkRelay" },
            },
            "*"
          ),
      ...
      handlePopupResponseEvent(e) {
        o("In content script sending response back to page"),
          ...
          void 0 !== e.data.id
            ...
            : o("Undefined id in service worker response handler");
      }
      handleExtensionUIRequestEvent(t) {
        if ("extensionUIRequest" !== t.type)
          return o("In content script, skipping event"), void o(t);
        if (void 0 !== t.data.id)
          if (void 0 !== t.data.action)
            switch (t.data.action) {
              case e.requestEthereumAccounts:
                this.createEthereumAccountsRequest(t);
                break;
          ...
          else o("Undefined action in content script");
        else o("Undefined id in content script");
      }
      createEthereumAccountsRequest(e) {
        const t = this.storage.getItem("session:secret"),
          ...
          s = {
            ...
            data: {
              ...
              dappInfo: { dappLogoURL: e.data.dappInfo.dappLogoURL },
              childSession: { id: n, secret: t },
        ...
        chrome.storage.onChanged.addListener((e) => {
          ...
          void 0 !== n &&
            ...
            window.postMessage(
              {
                type: "extensionUIResponse",
                data: { action: t.parentDisconnected },
              },
              "*"
            );
        }),
